...
module.exports = {
  activateAccount: (email, username) => {
    var url = `${config.get("domain")}/users/activeaccount/${username}`;
  ...
  forgotPass: (email, id) => {
    var url = `${config.get("domain")}/users/confirmchange/${id}`;
