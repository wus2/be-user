...
var notify_1 = require("./api/notify");
...
var Server = /** @class */ (function () {
    ...
    Server.prototype.api = function () {
        ...
        var notiRoute = express_1.default.Router();
        new notify_1.NotifyRoute().create(notiRoute);
        var paymentRoute = express_1.default.Router();
        new payment_1.PaymentRoute().create(paymentRoute);
